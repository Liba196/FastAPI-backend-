...
function renderMessageRow(message) {
  ...
  function renderTypingIndicator() {
    ...
    return h('div', { class: 'poessa-row poessa-row--assistant', 'data-typing-indicator': 'true' }, [
  ...
  function renderSuggestedQuestions(questions, onSelect) {
    ...
    return h('div', { class: 'poessa-suggestions', role: 'group', 'aria-label': 'የተጠቆሙ ጥያቄዎች' }, chips);
  }
  ...
  function renderWelcomeCard(questions, onSelectQuestion) {
    ...
    const notice = h('p', { class: 'poessa-welcome__notice' }, [
      'የእኔ AI ተግባር በአሁኑ ጊዜ በመገንባት ላይ ነው።',
    ]);
